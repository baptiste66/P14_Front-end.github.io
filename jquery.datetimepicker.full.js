    ...
    L.fn.xdsoftScroller = function(p, D) {
        return this.each(function() {
            ...
            u.on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", function(e) {
                ...
                m = d[0].offsetHeight,
                "mousedown" === e.type || "touchstart" === e.type ? (p.ownerDocument && L(p.ownerDocument.body).addClass("xdsoft_noselect"), L([p.ownerDocument.body, p.contentWindow]).on("touchend mouseup.xdsoft_scroller", function e() {
                ...
                1 < n ? u.hide() : (u.show(), u.css("height", parseInt(10 < r ? r : 10, 10)), f = d[0].offsetHeight - u[0].offsetHeight, !0 !== a && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(o.css("marginTop"), 10)) / (s - i)]))
    ...
    L.fn.datetimepicker = function(H, a) {
        ...
        return n = function(O) {
            ...
            function c(m) {
                ...
                "string" === L.type(m.mask) && (h(m.mask, O.val()) || (O.val(m.mask.replace(/[0-9]/g, "_")), g(O[0], 0)), O.on("paste.xdsoft", function(e) {
                    ...
                    if (48 <= n && n <= 57 || 96 <= n && n <= 105 || 8 === n || 46 === n) {
                        ...
                        if (r === m.mask.length) return e.preventDefault(),
                        !1;
                        for (r += 8 === n ? 0 : 1;
                    ...
                    if (-1 !== [M, w, j, J, z].indexOf(n) && I || -1 !== [y, b, x, v, k, S, p, T, D].indexOf(n)) return !0;
            ...
            _.setOptions = function(e) {
                ...
                e.highlightedPeriods && L.isArray(e.highlightedPeriods) && e.highlightedPeriods.length && (l = L.extend(!0, [], N.highlightedDates), L.each(e.highlightedPeriods, function(e, t) {
                    var a, n, r, o, i, s, d;
                ...
                N.validateOnBlur && O.off("blur.xdsoft").on("blur.xdsoft", function() {
                    ...
                    _.data("xdsoft_datetime").empty();
                        ...
                        if (e) L(this).val(E.formatDate(e, N.format));
                            ...
                            a = +[L(this).val()[2], L(this).val()[3]].join(""); ! N.datepicker && N.timepicker && 0 <= t && t < 24 && 0 <= a && a < 60 ? L(this).val([t, a].map(function(e) {
                                return 9 < e ? e : "0" + e
            ...
            _.on("xchange.xdsoft", function(e) {
                ...
                t = setTimeout(function() {
                    ...
                    for (e = c = 0; c < (N.hours12 ? 12 : 24); c += 1) for (e = 0; e < 60; e += N.step) {
                        var w = 60 * c + e;
            ...
            _.on("open.xdsoft", function(e) {
                ...
                !1 !== t && (_.show(), r(), L(N.contentWindow).off("resize.xdsoft", r).on("resize.xdsoft", r), N.closeOnWithoutClick && L([N.ownerDocument.body, N.contentWindow]).on("touchstart mousedown.xdsoft", function e() {
                    _.trigger("close.xdsoft"),
